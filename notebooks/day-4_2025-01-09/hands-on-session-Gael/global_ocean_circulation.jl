...
begin
	...
	bind_k = (@bind ktxt Select(["0","1","10"],default="0"))
...
#	- k  = $(bind_k) = flow field vertical level (set to 0 for 3D)
	...
	- zrng = $(bind_zrng) = vertical coordinate range
	"""
end
...
manifest_format = "2.0"
project_hash = "db168ee3a3f85c32211dc2ccd295ba57d5e574c5"
...
version = "0.6.2"
weakdeps = ["Climatology", "MITgcm", "Makie"]
